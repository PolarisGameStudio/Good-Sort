...
public class EndlessPack2Controller : NMSingleton<EndlessPack2Controller>
{
	public const string key = "end_less_pack_2";
	...
	private const string Item_Type = "end_less_pack_v2";
