...
public class UIPopup_InGame_Leaderboard_Item : MonoBehaviour
{
	...
	public Color[] colorSTTs;

	public Color[] colorNames;

	public void SetItemData(LeaderBoardUserInfo data, LeaderBoardUserInfo myData)
	{
	}
}
