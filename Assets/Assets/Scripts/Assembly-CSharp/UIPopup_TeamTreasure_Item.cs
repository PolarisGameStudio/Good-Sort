...
public class UIPopup_TeamTreasure_Item : MonoBehaviour
{
	[Serializable]
	public class Score
	{
	...
	private UserInfoTeamTreasure c_data;

	public int GetItemIndex => 0;

	public UserInfoTeamTreasure GetData => null;
	...
	public void SetItemData(int itemIndex, UserInfoTeamTreasure data)
	{
	}
}
