...
#endif
public class UMP : Singleton<UMP>
{
#if USE_ADMOB
...
#if UNITY_IOS
                Debug.Log(logPrefix + ATTrackingStatusBinding.GetAuthorizationTrackingStatus());
                if (ConsentInformation.ConsentStatus == ConsentStatus.Required && ATTrackingStatusBinding.GetAuthorizationTrackingStatus() == ATTrackingStatusBinding.AuthorizationTrackingStatus.DENIED)
                {
                    isChecking = false;
                }
                else
    ...
    public void ResetConsentInformation()
    {
        ...
        public static IEnumerator DOGatherConsent()
        {
